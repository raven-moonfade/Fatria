...
export const STARTER_SKILLS: SkillData[] = [
  ...
  // === 羞耻拍打 ===
  {
    ...
    upgrades: [
      ...
      { cost: 5, damageIncrease: 30, costReduction: 2, cooldownReduction: 0, specialEffect: '敏感+5%' },
    ],
...
export const PHYSICAL_SKILLS: SkillData[] = [
  ...
  // === 深吻 ===
  {
    id: 'sk_deep_kiss',
    name: '深吻',
    description: '一个令人窒息的深吻，扰乱对方的节奏',
    effectDescription: '造成100%性斗力伤害，乏力25%（1回合）',
    icon: 'Kiss',
    type: SkillType.PHYSICAL,
    rarity: SkillRarity.COMMON,
    staminaCost: 12,
    ...
    upgrades: [
      ...
      { cost: 2, damageIncrease: 15, costReduction: 1, cooldownReduction: 0 },
      { cost: 3, damageIncrease: 20, costReduction: 2, cooldownReduction: 1 },
      { cost: 4, damageIncrease: 25, costReduction: 2, cooldownReduction: 1, specialEffect: '乏力持续+1回合' },
      { cost: 5, damageIncrease: 30, costReduction: 3, cooldownReduction: 1 },
    ],
    voiceLine: '嘘...安静...',
  },
  // === 衣物破坏 ===
  {
    ...
    effectDescription: '造成40%性斗力伤害，降低防御20%并提高敏感度',
    icon: 'Scissors',
    type: SkillType.PHYSICAL,
    rarity: SkillRarity.COMMON,
    staminaCost: 10,
    ...
    buffs: [
      ...
      { type: BuffType.SENSITIVE, value: 5, isPercent: true, duration: 3, stackable: false },
    ],
    ignoreDefense: false,
    canBeDodged: true,
    canBeReflected: false,
    ...
    upgrades: [
      ...
      { cost: 3, damageIncrease: 15, costReduction: 1, cooldownReduction: 1 },
      { cost: 4, damageIncrease: 20, costReduction: 2, cooldownReduction: 1 },
      { cost: 5, damageIncrease: 25, costReduction: 2, cooldownReduction: 1, specialEffect: '敏感持续+2回合' },
    ],
    voiceLine: '穿这么多干嘛？',
  },
  // === 羞耻拍打 ===
  {
    ...
    effectDescription: '造成50%性斗力伤害，提高目标敏感度',
    icon: 'Hand',
    type: SkillType.PHYSICAL,
    rarity: SkillRarity.COMMON,
    staminaCost: 6,
    ...
    accuracy: 100,
    critModifier: 15,
    buffs: [{ type: BuffType.SENSITIVE, value: 8, isPercent: true, duration: 2, stackable: true, maxStacks: 5 }],
    ignoreDefense: false,
    canBeDodged: true,
    canBeReflected: false,
    hitCount: 1,
...
export const CHARM_SKILLS: SkillData[] = [
  ...
  // === 费洛蒙散发 ===
  {
    ...
    effectDescription: '造成240%魅力伤害，全体敌人持续快感4回合',
    icon: 'Wind',
    type: SkillType.CHARM,
    rarity: SkillRarity.RARE,
    staminaCost: 20,
    ...
    accuracy: 100,
    critModifier: 0,
    buffs: [{ type: BuffType.DOT_LUST, value: 10, isPercent: false, duration: 4, stackable: false }],
    ignoreDefense: false,
    canBeDodged: false,
    canBeReflected: false,
    hitCount: 1,
    ...
    upgrades: [
      { cost: 2, damageIncrease: 10, costReduction: 0, cooldownReduction: 0 },
      { cost: 3, damageIncrease: 15, costReduction: 2, cooldownReduction: 0, specialEffect: '持续快感+3' },
      { cost: 4, damageIncrease: 20, costReduction: 3, cooldownReduction: 1 },
      { cost: 5, damageIncrease: 25, costReduction: 4, cooldownReduction: 1, specialEffect: '持续快感+1回合' },
      { cost: 6, damageIncrease: 30, costReduction: 5, cooldownReduction: 1 },
    ],
    voiceLine: '闻到了吗？这就是我的味道...',
  },
...
export const CONTROL_SKILLS: SkillData[] = [
  ...
  },
  {
    ...
    effectDescription: '持续快感5回合，敏感+30%，忍耐-15%',
    icon: 'Flask',
    type: SkillType.CONTROL,
    rarity: SkillRarity.EPIC,
    staminaCost: 20,
    ...
    critModifier: 0,
    buffs: [
      { type: BuffType.DOT_LUST, value: 15, isPercent: false, duration: 5, stackable: false },
    ...
    upgrades: [
      { cost: 3, damageIncrease: 0, costReduction: 0, cooldownReduction: 0, specialEffect: '持续快感+3' },
      ...
      { cost: 6, damageIncrease: 0, costReduction: 4, cooldownReduction: 1, specialEffect: '持续快感+1回合' },
      { cost: 8, damageIncrease: 0, costReduction: 5, cooldownReduction: 2, specialEffect: '持续快感+5' },
    ],
    voiceLine: '慢慢享受吧~',
  },
];
